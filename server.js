...
app.engine('hbs', engine({
  ...
  defaultLayout: 'dashboard'    // Use dashboard as default layout
}))
...
/* ---------------------------------------
    ROUTES
--------------------------------------- */
// Temporarily modified to show dashboard directly
app.get('/', (req, res) => {
  res.render('users', {
    title: 'GC Dashboard | Users'
    // No need to specify layout as we set defaultLayout above
  })
})

// Also adding a direct route to dashboard for testing
...
app.get('/about', (req, res) => {
  res.render('about', {
    ...
    layout: false // No layout for about page
  })
})
...
app.get('/dashboard/user-applications', (req, res) => {
  res.render('layouts/user-applications', { // Point this to the layouts directory
